            ...
            <div class="col-4">
                <div class="card h-100">
                    <div class="card-body">
                        ...
                        <h5 class="card-title">React Interactive Dashboard <span class="badge text-bg-warning">New</span> </h5>
            ...
            <div class="col-4">
                <div class="card h-100">
                    <div class="card-body">
                        ...
                        <h5 class="card-title">Service 2 API Schema - Java<span class="badge text-bg-warning">New</span></h5>
